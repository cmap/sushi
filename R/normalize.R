...
#' @import tidyverse
#' @import magrittr
#' @return dataframe of normalized counts with the following columns
#'         - cb_intercept: intercept of the fit
#'         - norm_mae: median absolute error of the fit
#'         - norm_r2: r2 value of the fit
#'         - log2_normalized_n
#'         - normalized_n
