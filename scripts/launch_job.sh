...
PARAMS=(
  ...
  CONTROL_BARCODES GENERATE_QC_TABLES POSCON_TYPE L2FC_COLUMN DRC
  # sushi input files
  ...
  UNIVARIATE_BIOMARKER MULTIVARIATE_BIOMARKER BIOMARKER_FILE DR_COLUMN LFC_BIOMARKER AUC_BIOMARKER DR_PATH
)
