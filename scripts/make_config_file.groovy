...
pipeline {
    ...
    parameters {
        ...
        // Biomarker
        string(name: 'BIOMARKER_FILE', defaultValue: 'https://s3.us-east-1.amazonaws.com/biomarker.clue.io/h5/current/depmap_datasets_public.h5', description: 'Biomarker reference file.')
    }
