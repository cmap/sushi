...
pipeline {
    ...
    parameters {
        // Check boxes of modeuls to decide which ones to run
        ...
        string(name: 'CELL_LINE_COLS', defaultValue: 'pool_id,depmap_id', description: 'List of columns across the metadata files that are used to identify a unique cell line. This defaults to \"pool_id,depmap_id\", but can also include \"cell_set\" or descriptive columns like \"project_code\" that you would like to pass through the pipeline. Theis paramter is first used in COMPUTE_LFC.')
